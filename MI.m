function filename = MI(f,labels, desPath, dataset)
if(exist(desPath)==0)
    mkdir(desPath);
else
    'Path Already exists'
end
filename=fullfile(desPath,strcat('MI_ranks_', dataset));
